  ...
  return (
    <>
      ...
      <div className="w-full flex">
        ...
        These projects represent the intersection of design, development, and real-world problem solving. From freelance web apps to ERP customizations for logistics, each build reflects my ability to merge clean UI with scalable backend logic. Whether working solo or collaborating with teams, I focus on delivering user-centered, efficient, and maintainable solutions that drive results.
        </p>
      </div>
